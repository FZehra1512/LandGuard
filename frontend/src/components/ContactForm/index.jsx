...
const ContactPage = () => {
  return (
    <div className="relative max-h-fit pb-20 flex flex-col items-center justify-center bg-white">
      <img src={patternImage} alt="Contact" className="absolute -z-10 -top-[28rem] left-0 w-full object-cover" />
      <div className="text-center mb-8 w-3/5">
      ...
      <div className="flex flex-col md:flex-row items-center bg-compLightColor p-8 shadow-lg rounded-2xl w-10/12 max-w-6xl">
        {/* Image Section */}

...
const LoginForm = ({
  ...
  return (
    (<div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div
        className="text-balance text-center text-xs text-primary [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        By clicking continue, you agree to our <TermsOfService />{" "}
        and <PrivacyPolicy />.
      </div>
    </div>)
  );
